...
<div class="texte">
  ...
  <p class="texte">
    <a href='../view/old/enregistrement.php'><input type='submit' value='Ajouter une réservation' class='button'></a>
    <a href='../view/old/deconnexion.php'><input type='submit' value='Se déconnecter' class='button'></a>
  </p>
